...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Multitrack — Painel Músicos & Som" },
      { name: "description", content: "Player multipista sincronizado com painéis separados para músicos e sonoplastas." },
      { property: "og:title", content: "Multitrack — Painel Músicos & Som" },
      { property: "og:description", content: "Player multipista sincronizado com painéis separados para músicos e sonoplastas." },
